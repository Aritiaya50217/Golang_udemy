...
// การเข้ารหัสประเภทเอนโทรปี เพื่อใช้ในการบีบอัดข้อมูลจากแหล่งกำเนิดข้อมูล
...
func printCodes(tree HuffmanTree , prefix []byte){
	switch i := tree.(type) {
	case HuffmanLeaf :
		// if this ia a leaf node, then it contains one of the input
